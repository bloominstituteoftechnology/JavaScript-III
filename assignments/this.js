...
Student.prototype.Intro1 = function () {
    return `HELLO WORLD!!!! \n
        My name is: ${this.wholeName}! But you can call me: ${this.firstName},\n 
...
let genericYouCanDoThisSpeech = function (obj) {
    return (Student.prototype.Intro1() + Skills.prototype.brag() +
        Goals.prototype.fakeItTillYouMakeIt() + Setbacks.prototype.pushthroughyourproblems())
}

let idontreallyknowspeech = function (obj) {
    return (Student.Intro2() + Skills.lament() +
        Goals.dontfakeit() + Setbacks.pushthroughyourproblems())
}
...
console.log(genericYouCanDoThisSpeech(id0001))
