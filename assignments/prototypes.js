/*
  ...
  with their correct inheritance heirarchy.
...
function CharacterStats(statsObj) {
  GameObject.call(this, statsObj); // bind this to GameObject
  this.hp = statsObj.hp;
...
function Humanoid(attributes) {
  CharacterStats.call(this, attributes); // bind this to CharacterStats
