...
function GameObject(parentAttr){
...
function Villian(villAttr){
    ...
    this.points=villAttr.points;
    this.winPoints=villAttr.winPoints;
}
...
let vill2 = new Villian({
    ...
    healthPoints: 10,
    name: 'LionoftheSahara',
    team: 'the planet of the apes',
    weapons: [
        'A big hand',
        'A bi giant foot',
    ],
