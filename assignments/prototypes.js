...
/*
  ...
  * hp
  * name
  * takeDamage() // prototype method -> returns the string '<object name> took damage.' ${this.name}
...
/*
  ...
  * should inherit destroy() from GameObject through CharacterStats object.create
