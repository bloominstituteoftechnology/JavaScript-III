...
// Test you work by uncommenting these 3 objects and the list of console logs below:
  ...
  function Villian (villianAttributes) {
    ...
    this.axe = villianAttributes.axe;
    this.superCharge = villianAttributes.superCharge;
  }
  Villian.prototype = 
  Object.create(Humanoid.prototype);
  
  Villian.prototype.remove1 = function () {
    return `${this.name} blal la ${this.hp}.`};

    console.log(mage.remove1)