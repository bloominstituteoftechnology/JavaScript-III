...
function Villian(villianAttributes) {
  ...
  this.hitPower = villianAttributes.hitPower;

}

Villian.prototype = Object.create(Humanoid.prototype);

Villian.prototype.kicks = function() {
  return `${this.name} kicks for ${this.hitPower} damage.`;
}
...
function Hero(heroAttributes) {
  ...
  this.kickPower = heroAttributes.kickPower;

}

Hero.prototype = Object.create(Humanoid.prototype);

Hero.prototype.kicks = function() {
  return `${this.name} kicks for ${this.kickPower} damage.`;
}
...
console.log(villian.kicks());
console.log(hero.kicks());
