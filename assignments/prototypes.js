/*
  ...
  At the bottom of this file are 3 objects that all inherit from Humanoid.  Use the objects at the bottom of 
...
function Humanoid(humProperties) {
  CharacterStats.call(this, humProperties);
  this.faction = humProperties.faction;
  this.weapons = humProperties.weapons;
  this.language = humProperties.language;
}
