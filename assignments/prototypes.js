...
function Humanoid(attributesHumanoid) {
  CharacterStats.call(this, attributesHumanoid);
  this.faction = attributesHumanoid.faction;
  this.weapons = attributesHumanoid.weapons;
  this.language = attributesHumanoid.language;
}
