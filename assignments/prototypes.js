...
//Test you work by uncommenting these 3 objects and the list of console logs below:
  ...
  // * Give the Hero and Villian different methods that could be used to remove health points from objects which could result in destruction if health gets to 0 or drops below 0;
  ...
  Villian.prototype.attack = function (reciever) {
    reciever.hp = reciever.hp - this.power;
    if (reciever.hp < 1) {
      console.log(reciever.destroy());
    }
  }

  Villian.prototype.suicide = function () {
    this.hp = 0;
    this.destroy();
  }
  ...
  Hero.prototype.attack = function (reciever) {
    reciever.hp = reciever.hp - this.power;
    if (reciever.hp < 1) {
      console.log(reciever.destroy());
    }
