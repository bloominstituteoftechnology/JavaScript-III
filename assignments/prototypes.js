/*
  ...
  Each constructor function has unique properites and methods that are defined in
...
GameObject.prototype.destroy = function() {
  // Note that name will only exist in subclasses which define name, or
  // in GameObject instances that have explicitly had name defined.
  if (this.name) {
...
/*
  ...
  * weapons
  * language
  * greet() // prototype method -> returns the string
...
/*
   ...
   * Give the Hero and Villians different methods that could be used to remove health
     points from objects which could result in destruction if health gets to 0 or drops
     below 0;
