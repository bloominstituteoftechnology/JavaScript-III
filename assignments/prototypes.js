...
*/
const GameObject = function (gameObjParams) {
  this.createdAt = gameObjParams.createdAt ;
  this.dimensions = gameObjParams.dimensions ;
}
...
*/
const CharacterStats = function (charStatsParams) {
  
  GameObject.call(this, charStatsParams) ;
  
  this.hp = charStatsParams.hp ;
  this.name = charStatsParams.name ;  
}
//this line below inherits from GameObject to CharacterSets
...
function Humanoid (humanParams) {
  ...
  this.faction = humanParams.faction ;
