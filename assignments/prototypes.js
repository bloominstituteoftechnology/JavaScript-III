...
*/
 const GameObject = function (gameAttribute) {
...
*/
const CharacterStats = function (CharacterStats) {
...
*/
const Humanoid = function (HumAttribute) {
 CharacterStats.call(this, HumAttribute);
 this.faction = HumAttribute.faction;
