...
*/
function CharacterStats(numbers) {
  GameObject.call(this, numbers); //inherit GameObject properties
  this.healthPoints = numbers.healthPoints;
  this.name = numbers.name;
}
CharacterStats.prototype = Object.create(GameObject.prototype); //inherit GameObejct prototypes
...
*/
 function Humanoid(allurbase) {
   CharacterStats.call(this, allurbase); //inherit CharacterStats properties
