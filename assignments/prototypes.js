...
function Humanoid(playerCharacter){
  this.team = playerCharacter.team;
  this.weapons = playerCharacter.weapons;
  this.language = playerCharacter.language;
  
  CharacterStats.call(this, playerCharacter);
}
