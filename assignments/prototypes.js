...
const CharacterStats = function(stats) {
  GameObject.call(this, stats); //binds this to GameObject
  this.hp = stats.hp;
...
const Humanoid = function(humanStats) {
  CharacterStats.call(this, humanStats); // binds this to CharacterStats, which already inherits destroy()
