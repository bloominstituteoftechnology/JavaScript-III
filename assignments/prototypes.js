...
// Good guy method that will kill the bad guy with a single method 
Hero.prototype.arrowSentry = function (character) {
...
// Fight ------------------------
console.log(drOctavius.hp)
console.log(jerryArrows.arrowSentry(drOctavius));
