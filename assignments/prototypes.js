...
function VillainAndHero() {
  Humanoid.call(this);
}

VillainAndHero.prototype = Object.create(Humanoid.prototype);
VillainAndHero.prototype.healthGone = function() {
...
// Hero.prototype.goodKiller = function(){
//   if(this.healthPoints > 0){
//     return `${this.name} is the winner`
//   } else {
//     return false;
...
let killer = new VillainAndHero({});
console.log(killer.createdAt);
let dead = new VillainAndHero({});
