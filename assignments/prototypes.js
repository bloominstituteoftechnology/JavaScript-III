...
function Humanoid(humnanoidAttributes) {
  CharacterStats.call(this, humnanoidAttributes);
  this.faction = humnanoidAttributes.faction;
  this.weapons = humnanoidAttributes.weapons;
  this.language = humnanoidAttributes.language;
}
