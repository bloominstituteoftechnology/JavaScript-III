/*
  ...
  For this part of the assignment you will be implementing several constructor functions with their 
...
*/
function GameObject (dimensions, createdAt) {
  this.createdAt = Date(),
  this.dimensions = {
    length: 2,
    width: 1,
...
*/
function CharacterStats(hp, name, ...args) {
  this.hp = hp,
  this.name = name,
...
*/
function Humanoid(faction, weapons, language, ...attr) {
