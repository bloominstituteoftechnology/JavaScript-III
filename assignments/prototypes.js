...
function CharacterStats(charactersStatsAttributes) {
  GameObject.call(this, charactersStatsAttributes);
  this.hp = charactersStatsAttributes.hp;
  this.name = charactersStatsAttributes.name;
}
