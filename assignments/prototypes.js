...
// Test you work by un-commenting these 3 objects and the list of console logs below:
  ...
  Villain.prototype.removePoints = function(){
     this.healthPoints -=1;

     if(this.healthPoints <= 0){
       return this.destroy();
     }else{
      return 'Current Health Points: ' + this.healthPoints;
     }
  ...
  Hero.prototype.removePoints = function(){
     this.healthPoints -=1;
  ...
  console.log(thor.weapons);
  console.log(thor.removePoints()); 
  console.log(thor.removePoints());
  console.log(thor.removePoints());
  ...
  console.log(joker.removePoints()); 
  console.log(joker.removePoints());
  console.log(joker.removePoints());